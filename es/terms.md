...
- **«Servicio»**: API, consola de administración, SDK, documentación, y las funcionalidades de agregación, enrutamiento e inferencia de modelos de IA.
- **«Datos del cliente»**: la totalidad de los datos enviados por el usuario a través de la API.
- **«Resultados del modelo»**: las respuestas generadas por los modelos de IA.
- **«Proveedores de modelos de terceros»**: los desarrolladores de los modelos subyacentes.

## 3. Cuenta de usuario

El usuario está obligado a registrarse con información veraz y actualizada. Le corresponde mantener la confidencialidad de sus credenciales de acceso. La creación de múltiples cuentas con el propósito de eludir la facturación está estrictamente prohibida.
...
3. La difamación;
4. La creación o distribución de software malicioso;
5. El acceso no autorizado a redes o sistemas informáticos;
6. Cualquier otro contenido ilícito.

Asimismo, se prohíbe la reventa del servicio o cualquier uso comercial no autorizado.
...
El presente acuerdo constituye la totalidad del contrato entre las partes. La invalidez de una cláusula no afecta a la vigencia de las restantes disposiciones.
